...
const JobList = () => {
  ...
  const experienceItems = {
     NTTDATA: {
      ...
      desc: [
        "Monitored and analyzed security alerts using SOC tools to identify potential cybersecurity incidents.",
        "Worked with the Cyware platform to investigate, update, and manage security incident tickets while following standard incident response procedures.",
        "Collaborated with the cybersecurity team to learn threat monitoring, incident handling, and industry best practices in Security Operations.",
      ],
    },
  };
